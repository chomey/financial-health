    ...
    <>
      ...
      {isOpen &&
        createPortal(
          ...
          >
            <div
              className={`relative max-h-[95vh] w-full max-w-[95vw] overflow-auto rounded-2xl bg-slate-900 border border-white/10 p-6 shadow-2xl transition-all duration-150 ease-out ${isVisible ? "scale-100 opacity-100" : "scale-95 opacity-0"}`}
            >
              <button
