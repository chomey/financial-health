...
describe("changelog data", () => {
  it("contains entries for completed tasks (144 entries, versions 1-144)", () => {
    expect(CHANGELOG.length).toBe(144);
  });
  ...
  it("covers versions 1 through 144", () => {
...
describe("getChangelogByMilestone", () => {
  ...
  it("groups entries correctly by milestone range", () => {
    ...
    expect(milestones[0].entries.length).toBe(5); // 140, 141, 142, 143, 144
